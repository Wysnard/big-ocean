...
export const defaultTestConfig: AppConfigService = {
	...
	portraitSpineExtractorModelId: "claude-sonnet-4-6",
	portraitSpineThinkingBudgetTokens: 2048,
	portraitSpineVerifierModelId: "claude-haiku-4-5-20251001",
	portraitProseRendererModelId: "claude-sonnet-4-6",
	portraitProseRendererTemperature: 0.5,
