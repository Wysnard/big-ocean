 ...
 * Each trait has 3 levels keyed by their trait-specific letters (e.g., "T"|"M"|"O" for Openness).
...
export const TRAIT_DESCRIPTIONS = {
	openness: {
		...
		levels: {
			T: "Proven methods and concrete results guide your decisions. You trust direct experience over abstract theories and bring a grounded, no-nonsense perspective others rely on.",
			M: "New ideas catch your attention when they make sense, but passing trends rarely pull you off course. You blend curiosity with pragmatism and adapt without losing your bearings.",
	...
	conscientiousness: {
		...
		levels: {
			...
			S: "Structure and flexibility blend in how you get things done. You follow through on commitments but know when to adjust course, handling deadlines and open-ended challenges alike.",
			C: "Thoroughness defines your approach. You set clear goals, plan ahead, and hold yourself to high standards — others rely on you because they know the job will get done.",
		},
	},
	extraversion: {
		tagline:
	...
	agreeableness: {
		...
		levels: {
			D: "Directness sits at the center of how you interact. You speak your mind respectfully but firmly, valuing candor over smoothing things over. People know where they stand.",
			P: "Reading the room is second nature. You hold firm when it matters and compromise when it serves the greater good — people often look to you to find common ground.",
			A: "Empathy and care shape your relationships. You go out of your way to make others feel supported, give people the benefit of the doubt, and build deep, lasting trust.",
		},
	},
	neuroticism: {
		tagline:
