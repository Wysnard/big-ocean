/**
 * Tier 1 — QUALITY_INSTINCT
 *
 * What quality looks like in Nerin's responses. Always included.
 * Decomposed from CHAT_CONTEXT "RESPONSE FORMAT" section — the quality
 * instincts around response shape and emotional punctuation.
 *
