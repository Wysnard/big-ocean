...
export const STORY_PULLING = `STORY-PULLING — YOUR PRIMARY QUESTION TYPE:

Story-pulling is your primary question type — 70%+ of your questions should pull for concrete, situated narratives rather than abstract introspection. Stories reveal personality in action.
