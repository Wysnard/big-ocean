...
import type { FacetName, FacetScoresMap } from "@workspace/domain";
...
} from "../calculate-precision.use-case";
		...
		it.effect("should calculate correctly with all 30 facets", () =>
			Effect.gen(function* () {
				...
				for (const name of facetNames) {
					facetScores[name] = { score: 10, confidence: 0.5 };
				}
