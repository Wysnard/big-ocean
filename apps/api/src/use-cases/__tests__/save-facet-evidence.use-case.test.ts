...
import {
  saveFacetEvidence,
  type SaveFacetEvidenceInput,
} from "../save-facet-evidence.use-case.js";
    ...
    it.effect("should handle all 30 facet types", () =>
      Effect.gen(function* () {
        ...
        const multipleEvidence: FacetEvidence[] = [
          { messageId: "msg_all_facets", facetName: "imagination", score: 15, confidence: 0.8, quote: "test", highlightRange: { start: 0, end: 4 } },
          { messageId: "msg_all_facets", facetName: "artistic_interests", score: 14, confidence: 0.7, quote: "test", highlightRange: { start: 0, end: 4 } },
          { messageId: "msg_all_facets", facetName: "self_efficacy", score: 16, confidence: 0.85, quote: "test", highlightRange: { start: 0, end: 4 } },
          { messageId: "msg_all_facets", facetName: "friendliness", score: 17, confidence: 0.9, quote: "test", highlightRange: { start: 0, end: 4 } },
          { messageId: "msg_all_facets", facetName: "trust", score: 18, confidence: 0.88, quote: "test", highlightRange: { start: 0, end: 4 } },
          { messageId: "msg_all_facets", facetName: "anxiety", score: 10, confidence: 0.75, quote: "test", highlightRange: { start: 0, end: 4 } },
        ];
