...
export function HowItWorks() {
	return (
		<section
			...
			className="mx-auto max-w-[900px] px-6 py-16 sm:py-20 min-[1200px]:max-w-[1000px] min-[1440px]:max-w-[1100px]"
		>
			<h2 className="mb-10 text-center font-heading text-[clamp(1.5rem,3vw,2rem)] font-bold text-foreground sm:mb-14">
				How It Works
			</h2>
