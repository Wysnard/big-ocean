...
import { Handshake, Heart, Lightbulb, TrendingUp, Waves, Zap } from "lucide-react";
		...
		<div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
			...
			<section className="relative py-20 px-6 text-center overflow-hidden">
				...
				<div className="relative max-w-5xl mx-auto">
					...
					<p className="text-lg text-gray-400 max-w-3xl mx-auto mb-8">
						Take a scientifically-backed personality assessment powered by AI. Understand yourself better
						through the Big Five personality model, one of the most respected frameworks in psychology.
					</p>
					<div className="flex flex-col items-center gap-4">
						...
						<p className="text-gray-400 text-sm mt-2">Takes about 10-15 minutes · No account needed</p>
					</div>
				</div>
			</section>
			...
			<section className="py-16 px-6 max-w-4xl mx-auto">
				<div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 mb-12">
					<h2 className="text-3xl font-bold text-white mb-4">What is the Big Five?</h2>
					<p className="text-gray-300 leading-relaxed mb-4">
						The Big Five (also called OCEAN) is one of the most widely accepted personality models in
						psychology. It measures five fundamental dimensions of personality that help explain how
						people differ from one another.
					</p>
					<p className="text-gray-400">
						Our AI-powered therapist will ask you thoughtful questions about your behaviors, preferences,
						and reactions to different situations. As you answer, the system evaluates your personality
						across each dimension until it reaches high confidence in all five traits.
					</p>
				</div>
			</section>
			...
			<section className="py-16 px-6 max-w-7xl mx-auto">
				<h2 className="text-3xl font-bold text-white text-center mb-12">The Five Dimensions</h2>
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
					{traits.map((trait) => (
						...
						>
							...
							<h3 className="text-xl font-semibold text-white mb-3">{trait.title}</h3>
							<p className="text-gray-400 leading-relaxed text-sm">{trait.description}</p>
						</div>
					))}
				</div>
			</section>
			...
			<section className="py-20 px-6">
				<div className="max-w-3xl mx-auto text-center">
					<h2 className="text-4xl font-bold text-white mb-6">Ready to Understand Yourself Better?</h2>
					<p className="text-xl text-gray-300 mb-8">
						Chat with our AI therapist and get your personalized Big Five personality profile in minutes.
					</p>
					<Button
						onClick={() => navigate({ to: "/chat", search: { sessionId: undefined } })}
						size="lg"
