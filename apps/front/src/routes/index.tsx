	...
	return (
		<PageMain>
			<DepthScrollProvider>
				...
				<section aria-labelledby="homepage-conversation-preview-heading">
					<h2 id="homepage-conversation-preview-heading" className="sr-only">
					...
					<ConversationFlow>
						...
						<MessageGroup>
							<ChatBubble variant="nerin">
								...
								<p>
									That &ldquo;but&rdquo;&nbsp;&mdash;&nbsp;that&rsquo;s the part no test captures.
									That&rsquo;s the part I&rsquo;m interested in.
								</p>
							</ChatBubble>
						</MessageGroup>
						...
						<MessageGroup>
							<ChatBubble variant="user">
								I&rsquo;ve done a few of these. They never really got it right. I&rsquo;d read the result
								and think &ldquo;that&rsquo;s... someone, but not me.&rdquo;
							</ChatBubble>
						</MessageGroup>
						...
						<MessageGroup>
							<ChatBubble variant="nerin">
								...
								<p>
									Those tests aren&rsquo;t broken&nbsp;&mdash;&nbsp;they&rsquo;re just measuring the wrong
									way. They ask you to rate yourself on a scale, average out the answers, and hand you a
									type.
								</p>
								<p>
									But you&rsquo;re not an average. You&rsquo;re a pattern of
									contradictions&nbsp;&mdash;&nbsp;and that&rsquo;s what makes you interesting. A scale of 1
									to 7 can&rsquo;t hold that. A conversation can.
								</p>
							</ChatBubble>
						</MessageGroup>
						...
						<MessageGroup>
							<ChatBubble variant="nerin">
								...
								<p>
									...
									labels&nbsp;&mdash;&nbsp;five landscapes. Take Openness&nbsp;&mdash;&nbsp;it&rsquo;s not
									just &ldquo;creative or not creative.&rdquo; It&rsquo;s Adventurousness, Artistic
									Interests, Emotionality, Imagination, Intellect, Liberalism. Six flavors of one trait.
								</p>
						...
						<MessageGroup>
							<ChatBubble variant="nerin">
								That&rsquo;s actually the person who built big-ocean.
							</ChatBubble>
						</MessageGroup>
						...
						<MessageGroup>
							<ChatBubble variant="vincent">
								...
								admit. They&rsquo;d tell me things that were true on the surface but never felt complete.
								When I first read what Nerin wrote about me, I sat with it for a long time. Not because it
								told me something I didn&rsquo;t know&nbsp;&mdash;&nbsp;but because it named things
								I&rsquo;d been carrying without words for them.
								<br />
								<br />
						...
						<MessageGroup>
							<ChatBubble variant="nerin">
								...
								<p>
									That&rsquo;s a fair reaction&nbsp;&mdash;&nbsp;and it&rsquo;s why your results are private
									by default. No one sees your portrait unless you decide to share it. No public profile. No
						...
						<MessageGroup>
							<ChatBubble variant="nerin">
								...
								<p>
									And if you <em>do</em> decide to share&nbsp;&mdash;&nbsp;you can invite someone to take
									their own dive and overlay your profiles side by side. See exactly where you align and
									where you don&rsquo;t.
								</p>
