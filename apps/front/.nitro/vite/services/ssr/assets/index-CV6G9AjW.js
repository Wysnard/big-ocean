import { q as jsxRuntimeExports, c as reactExports, R as React, y as commonjsGlobal, g as getDefaultExportFromCjs } from "../server.js";
import { c as createLucideIcon$1, r as reactDomExports, a as ReactDOM, u as useNavigate, X as X$1, b as Route } from "./router-BKS0gMzo.js";
import { c as composeRefs, u as useComposedRefs, B as Button } from "./button-eboxan6j.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { u as useAuth } from "./use-auth-DbltyjcL.js";
import { a as useSendMessage, b as useResumeSession } from "./use-assessment-DBdvijJ-.js";
...
const ChartColumn = createLucideIcon$1("chart-column", __iconNode$2);
const __iconNode$1 = [
  [
    "path",
    {
...
const Send = createLucideIcon$1("send", __iconNode$1);
...
function useTherapistChat(sessionId) {
  ...
  const [hasShownCelebration, setHasShownCelebration] = reactExports.useState(false);
  ...
  const retryLastMessage = reactExports.useCallback(() => {
...
function SignUpModal({ isOpen, sessionId, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      await signUp.email(email, password, void 0, sessionId);
      setSuccess(true);
      setTimeout(() => {
        onClose();
      }, 1500);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-slate-800 border-slate-700 sm:max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-white text-xl", children: "Save your results?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-slate-300", children: "Sign up to continue and keep your personality insights" })
    ] }),
    success ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-green-400 text-lg font-medium mb-2", children: "✓ Your results are being saved!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 text-sm", children: "You can now access them anytime" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-900/20 border border-red-700/30 text-red-300 p-3 rounded text-sm", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "modal-email", className: "block text-sm font-medium text-slate-300 mb-1", children: "Email" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "modal-email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "modal-password", className: "block text-sm font-medium text-slate-300 mb-1", children: "Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "modal-password",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 mt-1", children: "Minimum 12 characters (NIST 2025)" })
      ] }),
...
function ErrorBanner({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mb-2 p-3 bg-red-900/20 border border-red-700/30 rounded-lg flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-200", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      onRetry && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onRetry, className: "text-xs text-red-300 hover:text-white", children: "Retry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onDismiss, className: "text-xs text-red-400 hover:text-red-200", children: "×" })
    ] })
  ] });
}
const ProgressBar = ({
  ...
  const defaultLabel = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `w-full max-w-md mx-auto px-4 py-2 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-300", children: displayLabel }),
      showPercentageValue && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-slate-400 font-medium", children: [
...
function TypingIndicator() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[85%] lg:max-w-md px-4 py-3 rounded-lg bg-slate-700/50 border border-slate-600", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
...
function TraitSidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-slate-800/50 border-slate-700", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg text-white", children: isCompleted ? "Assessment Complete!" : "Current Scores" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
      ...
      isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-green-900/20 border border-green-700/30 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-green-200 font-medium", children: "Assessment completed successfully!" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function TherapistChat({ sessionId, onMessageClick }) {
  ...
  const navigate = useNavigate();
  const [showSignUpModal, setShowSignUpModal] = reactExports.useState(false);
  const [hasShownModal, setHasShownModal] = reactExports.useState(false);
  const [showMobileTraits, setShowMobileTraits] = reactExports.useState(false);
  const avgConfidence = reactExports.useMemo(() => {
    return (traits.openness + traits.conscientiousness + traits.extraversion + traits.agreeableness + traits.neuroticism) / 5;
  }, [traits]);
  ...
  const handleMessageClick = (messageId, role) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800/50 border-b border-slate-700 px-4 md:px-6 py-3 md:py-4 shadow-sm backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent", children: "Big Five Personality Assessment" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs md:text-sm text-gray-400 mt-1", children: [
          "Session ID:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-slate-700 px-2 py-0.5 md:py-1 rounded text-gray-300 text-xs", children: sessionId })
        ] })
      ] }),
      messages.length > 0 && !isResuming && !resumeError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-800/50 border-b border-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: avgConfidence, showPercentage: true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex gap-4 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
          isResuming && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-blue-400 mx-auto" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 mt-4", children: "Loading your assessment..." })
          ] }) }),
          !isResuming && resumeError && (resumeError.message.includes("404") || resumeError.message.includes("SessionNotFound")) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-md", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-lg", children: "Session not found" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 mt-2", children: "This session may have expired or doesn't exist." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mt-4", onClick: () => navigate({ to: "/chat" }), children: "Start New Assessment" })
          ] }) }),
          !isResuming && resumeError && !resumeError.message.includes("404") && !resumeError.message.includes("SessionNotFound") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-md", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-lg", children: "Something went wrong" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 mt-2", children: "Unable to load your assessment." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mt-4", onClick: () => window.location.reload(), children: "Retry" })
          ] }) }),
          !isResuming && !resumeError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-4 mb-4", children: [
            messages.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-md bg-slate-800/50 border-slate-700", children: [
              ...
              "div",
              {
                ...
                children: msg.role === "user" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1 text-blue-100", children: msg.timestamp.toLocaleTimeString() })
                    ]
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: msg.content }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1 text-gray-400", children: msg.timestamp.toLocaleTimeString() })
                    ]
                  }
                )
              },
          ...
          errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsx(
            ErrorBanner,
            {
              ...
              onRetry: errorType === "network" || errorType === "generic" ? retryLastMessage : void 0,
              onDismiss: clearError,
              autoDismissMs: errorType === "budget" || errorType === "rate-limit" ? 0 : 5e3
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-800/50 border border-slate-700 rounded-lg p-3 md:p-4 backdrop-blur-sm sticky bottom-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ref: inputRef,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex md:w-80 flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TraitSidebar, { traits, isCompleted, sessionId }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden fixed bottom-20 right-4 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-5 w-5 text-white" })
        }
      ) }),
      showMobileTraits && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden fixed inset-0 z-50 flex items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-h-[60vh] overflow-y-auto bg-slate-900 border-t border-slate-700 rounded-t-xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-white", children: "Trait Scores" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TraitSidebar, { traits, isCompleted, sessionId })
        ] })
      ] }),
      isConfidenceReady && !hasShownCelebration && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-50 flex items-center justify-center bg-black/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800 border border-slate-700 rounded-2xl p-8 max-w-md text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-white", children: "Your Personality Profile is Ready!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 mt-2", children: "You've reached 70%+ confidence" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex gap-3 justify-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setHasShownCelebration(true), children: "Keep Exploring" })
        ] })
      ] }) })
    ] })
  ] });
