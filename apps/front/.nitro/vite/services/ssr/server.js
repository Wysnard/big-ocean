...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BcHzo2QZ.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-CzTgl8kG.js").then((n2) => n2.v);
