...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-MeCQtDRK.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BKS0gMzo.js").then((n2) => n2.y);
