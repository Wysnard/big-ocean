...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BCyy4V7r.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-47ReI916.js").then((n2) => n2.E);
