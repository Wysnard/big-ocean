...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-oWJ8n3ft.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-D76SAzqx.js").then((n2) => n2.K);
