...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DpUTRvnV.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BunWQw_O.js").then((n2) => n2.E);
