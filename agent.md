...
This file is the **single authoritative** source of guidance for AI coding agents (Cursor, Claude Code, and similar) when working with code in this repository.
